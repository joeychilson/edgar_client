defmodule EDGARTest do
  ...
  test "entity directory found" do
    entity_directory = EDGAR.get_entity_directory("320193")
  ...
  test "entity directory not found" do
    entity_directory = EDGAR.get_entity_directory("1")
    assert {:error, :not_found} = entity_directory
  end

  test "filing directory found" do
    filing_directory = EDGAR.get_filing_directory("320193", "000032019320000010")
  ...
  test "filing directory not found" do
    filing_directory = EDGAR.get_filing_directory("1", "1")
    assert {:error, :not_found} = filing_directory
  end

  test "company tickers found" do
    company_tickers = EDGAR.get_company_tickers()
